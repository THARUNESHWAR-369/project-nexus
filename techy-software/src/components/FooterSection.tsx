      ...
      <div className="footer-container sizer">
        <div className="footer-content flex gap-10 flex-wrap">
          <div className="footer-intro max-w-[22em] w-full flex flex-col gap-8">
            <h1 className="inline-block text-3xl font-extrabold">
              <span className="text-transparent inline-block bg-clip-text bg-primary-gradient mr-1">
                Techy
              </span>
              Software
            </h1>
            <p>
              We develop websites for your business, bringing your vision to
              life and propelling your business into the digital realm.
            </p>
            <div className="social-media-links">
              <ul className="flex gap-3">
                ...
                <li>
                  <a href="https://wa.link/mqch1c" target="_blank">
                    <svg
          ...
          <div className="footer-quick-links max-w-[20em] w-full">
          ...
          <div className="footer-newsletter max-w-[18em] w-full max-[720px]:max-w-full">
            ...
            <div className="newsletter flex flex-col gap-2">
              ...
              />
              <textarea
                className="bg-transparent border-2 border-gray-500 rounded-md p-2"
                placeholder="Your Feedback..."
              ></textarea>
              <button className="flex bg-primary-gradient rounded-md py-3 text-center justify-center gap-2 font-bold text-lg items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="24px"
